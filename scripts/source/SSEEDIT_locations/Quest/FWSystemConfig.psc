...
Event OnPageReset(string page)
	...
	If ModEnabled.GetValueInt()==0 && CloakingSpellEnabled.GetValueInt()==0 && bForceMenu==false
		SetTitleText("Beeing Female v" + FWVersion.GetVersionString();/ + GetBanePatchVersion()/;) ;Tkc (LOverslab): now version can be easy changed in BeeingFemale\Version\BF_version.ini
	...
	ElseIf page == Pages[FW_MENU_PAGE_Cycle]
		...
		AddToggleOptionST("ToggleMenstrualBlood", "$FW_MENU_CYCLE_MenstrualBlood", GlobalMenstruating.GetValueInt()==1)
	...
	ElseIf page == Pages[FW_MENU_PAGE_Pregnancy]
		...
		AddSliderOptionST("SliderBabyRaceDeterm", "$FW_MENU_PREGNANCY_BabyRaceDeterm", myBFA_ProbChildRaceDeterminedByFather.getValueInt(), "{0}%")
...
State SliderBabyRaceDeterm
	Event OnSliderOpenST()
		SetSliderDialogStartValue(myBFA_ProbChildRaceDeterminedByFather.GetValueInt())
	...
	Event OnDefaultST()
		myBFA_ProbChildRaceDeterminedByFather.SetValue(50)
